...
using WeatherAcquisition.API.Models;
...
namespace WeatherAcquisition.API.Controllers.Base
{
    ...
    public class MappedEntityController<T, TBase> : ControllerBase where TBase : IEntity
    {
        ...
        protected virtual IPage<T> GetItem(IPage<TBase> page) => new Page<T>(GetItem(page.Items), page.PageIndex, page.PageIndex, page.PageSize);
